...
import { runSlackAutomationsForTrigger } from '@/src/server/slackAutomations/run';
...
//
// Schedule (vercel.json): once per day at 14:00 UTC. We could refine
// per-property timezone later, but a single sweep at a sensible global
// hour is sufficient for v1: dedup makes re-runs harmless and the
// reservation date column is wall-clock anyway.
//
