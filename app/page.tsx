  ...
  if (isMobile) {
    return (
      <>
        ...
        {/* Card Detail Sheet - shared component for mobile */}
        <CardDetailSheet
          selectedCard={selectedCard}
          setSelectedCard={setSelectedCard}
          fullscreenTask={fullscreenTask}
          setFullscreenTask={setFullscreenTask}
          showAddTaskDialog={showAddTaskDialog}
          setShowAddTaskDialog={setShowAddTaskDialog}
          showPropertyProjects={showPropertyProjects}
          setShowPropertyProjects={setShowPropertyProjects}
          ...
          fetchAvailableTemplates={fetchAvailableTemplates}
