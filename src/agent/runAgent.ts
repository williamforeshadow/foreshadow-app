...
- Slack confirmation buttons: on Slack, every write preview should return pending_action_id unless the preview is a no-op. When a preview returns pending_action_id, present the plan once and tell the user to press Confirm or Cancel below. Do NOT ask them to type "yes", "go", or provide internal ids.
