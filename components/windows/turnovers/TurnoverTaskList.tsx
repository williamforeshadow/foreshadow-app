        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-2 flex-1 min-w-0">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              {/* Show the key icon iff the task has its own FK to a
                  reservation (auto-generated by automation). When the FK
                  matches the panel's selected card, KeyAffordance renders
                  a static no-op variant (clicking the same key the user
                  just opened the panel from would be confusing); when it
                  points elsewhere — e.g. a contingent task FK'd to a
                  future stay that falls into this card's window — the
                  icon navigates to the source reservation. Manual /
                  recurring tasks have no FK and render plain. */}
              <KeyAffordance
