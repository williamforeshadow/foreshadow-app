                ...
                {visibleBars.map((bar) => {
                  ...
                  return (
                    <button
                      ...
                      className={`pointer-events-auto absolute text-left transition-all flex items-center overflow-hidden border text-[#1a1a18] dark:text-[#e8e7e3] text-[11px] font-medium bg-[rgba(167,139,250,0.16)] dark:bg-[rgba(167,139,250,0.18)] border-[rgba(167,139,250,0.26)] dark:border-[rgba(167,139,250,0.30)] ${
                        isSelected
