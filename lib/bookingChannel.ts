...
const CANONICAL_BY_KEY: Record<string, CanonicalChannel> = {
  ...
  homeaway: 'vrbo',
  homeawayapiv2: 'vrbo',
  homeaway2: 'vrbo', // Hospitable's Vrbo platform value
  vrbo: 'vrbo',
  bookingcom: 'bookingcom',
  booking: 'bookingcom', // Hospitable's Booking.com platform value ("bookingCom")
  expedia: 'expedia',
  direct: 'direct',
  manual: 'manual',
};
...
const CHANNEL_LABELS: Record<string, string> = {
  ...
  googlevacationrentals: 'Google Vacation Rentals',
  direct: 'Direct',
  partner: 'Partner',
  manual: 'Manual',
};
